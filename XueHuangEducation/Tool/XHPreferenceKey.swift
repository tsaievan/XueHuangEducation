...
extension PreferenceKeys {
    ...
    static let USERDEFAULT_PUSH_INFO_ID = XHPreferenceKey<String>("USERDEFAULT_PUSH_INFO_ID")
    static let USERDEFAULT_FIRST_INSTALL_APP = XHPreferenceKey<Bool>("USERDEFAULT_FIRST_INSTALL_APP")
    ///< 是否记住密码的开关
